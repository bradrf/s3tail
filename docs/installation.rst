...
The sources for s3tail can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/bradrf/s3tail
.. _tarball: https://github.com/bradrf/s3tail/tarball/master
